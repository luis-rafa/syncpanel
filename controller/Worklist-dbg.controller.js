sap.ui.define([
	...
	return BaseController.extend("com.colsubsidio.syncpanel.syncpanel.controller.Worklist", {
		...
		onSendService: function (oProperty, oControl, sAditional,isDilog) {
			...
			$.ajax({
				...
				success: function (odata) {
					...
					sap.m.MessageToast.show("Datos Sincronizados correctamente.")
					if(isDilog){
						oControl.close();
					}
				},
		...
		onSync: function () {
			...
			console.log(sUrl)
			that.onSendService(oModelDialog, oDialogsSync, sUrl, true);
		...
		onInit: function () {
			...
			var oTiles = {
				"TileCollection": [{
					...
					"info": "Habilitado",
					"method": 3,
					"url": "dispensacion/sync/contratosMarco",
					"infoState": "Success"
				}, {
					"icon": "sap-icon://decision",
					...
					"info": "Habilitado",
					"infoState": "Success",
					"url": "dispensacion/sync/farmacias"
				}, {
					"icon": "sap-icon://database",
					"title": "IPS / Convenio",
					"info": "Habilitado",
					"infoState": "Success",
					"url": "dispensacion/sync/ips/",
					"param": [{
						"grupo": [{
							type: "l",
							text: "Convenio",
					...
					"info": "Habilitado",
					"url": "dispensacion/sync/motivosPendiente",
					"infoState": "Success"
				}, {
					...
					"info": "Habilitado",
					"url": "dispensacion/sync/tablasMaestras",
					"infoState": "Success"
				}, {
					"icon": "sap-icon://database",
					"title": "Topes Moléculas",
					"info": "Habilitado",
					"url": "dispensacion/sync/topesMolecula",
					"infoState": "Success"
				}]
			};
