		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Panel de Sincronizacion",
									"targetURL": "#PaneldeSincronizacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PaneldeSincronizacion-display": {
								"semanticObject": "PaneldeSincronizacion",
								"action": "display",
								"description": "Master Data Synchronization Panel",
								"title": "Panel de Sincronizacion",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.colsubsidio.syncpanel.syncpanel",
									"url": sap.ui.require.toUrl("com/colsubsidio/syncpanel/syncpanel")
								}
							}
						}
					}
